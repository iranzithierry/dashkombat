...
const keyboardStyles = tv({
	slots: {
		...
		kbd: [
			"text-center text-current/70 capitalize group-data-focused:text-fg forced-colors:group-data-focused:text-[HighlightText]",
			"inline-grid min-h-5 min-w-[2ch] place-content-center rounded text-[.75rem] uppercase group-data-hovered:text-fg group-data-disabled:opacity-50 group-data-focused:opacity-90",
		],
	},
})
