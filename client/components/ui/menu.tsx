...
const menuStyles = tv({
	slots: {
		...
		trigger: [
			"relative cursor-pointer inline text-left data-focused:outline-hidden data-pressed:outline-hidden data-focus-visible:ring-1 data-focus-visible:ring-primary",
		],
	},
})
